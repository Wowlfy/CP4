...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AdminJobController' => 'getAdminJobControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.coverLetter' => 'getSmartUniqueNamer_CoverLetterService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.resume' => 'getSmartUniqueNamer_ResumeService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('sWw6EWFzCR', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-8xozf+ufS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'vich_uploader.listener.clean.coverLetter' => ['privates', 'vich_uploader.listener.clean.coverLetter', 'getVichUploader_Listener_Clean_CoverLetterService', true],
            'vich_uploader.listener.clean.resume' => ['privates', 'vich_uploader.listener.clean.resume', 'getVichUploader_Listener_Clean_ResumeService', true],
            'vich_uploader.listener.remove.coverLetter' => ['privates', 'vich_uploader.listener.remove.coverLetter', 'getVichUploader_Listener_Remove_CoverLetterService', true],
            'vich_uploader.listener.remove.resume' => ['privates', 'vich_uploader.listener.remove.resume', 'getVichUploader_Listener_Remove_ResumeService', true],
            'vich_uploader.listener.upload.coverLetter' => ['privates', 'vich_uploader.listener.upload.coverLetter', 'getVichUploader_Listener_Upload_CoverLetterService', true],
            'vich_uploader.listener.upload.resume' => ['privates', 'vich_uploader.listener.upload.resume', 'getVichUploader_Listener_Upload_ResumeService', true],
        ], [
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber' => '?',
            'vich_uploader.listener.clean.coverLetter' => '?',
            'vich_uploader.listener.clean.resume' => '?',
            'vich_uploader.listener.remove.coverLetter' => '?',
            'vich_uploader.listener.remove.resume' => '?',
            'vich_uploader.listener.upload.coverLetter' => '?',
            'vich_uploader.listener.upload.resume' => '?',
        ]), [0 => 'vich_uploader.listener.clean.resume', 1 => 'vich_uploader.listener.clean.coverLetter', 2 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 3 => 'vich_uploader.listener.remove.resume', 4 => 'vich_uploader.listener.upload.resume', 5 => 'vich_uploader.listener.remove.coverLetter', 6 => 'vich_uploader.listener.upload.coverLetter']);
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\LegalNoticeRepository' => ['privates', 'App\\Repository\\LegalNoticeRepository', 'getLegalNoticeRepositoryService', true],
            ...
            'App\\Repository\\LegalNoticeRepository' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BYKUz+8Vh2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3eDOnLyQle', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0JEb1HrXLf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x7-oivG0Rm', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GolJ3roi1+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QT1L7s0LH8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'mailer_to': $value = $this->getEnv('resolve:MAILER_TO_ADDRESS'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'vich_uploader.mappings' => [
                'resume' => [
                    'uri_prefix' => '/uploads/resume',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/uploads/resumes'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.resume',
                        'options' => [
                ...
                'coverLetter' => [
                    'uri_prefix' => '/uploads/coverLetter',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/uploads/coverLetters'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.coverLetter',
                        'options' => [

...
class __TwigTemplate_b3991f34135b7f8d4fd5efd80cc0ac047663f7dc167056c384a432ae7e9a3bdb extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("email/layoutEmail.html.twig", "reset_password/email.html.twig", 1);
    ...
    <p>Bonjour!</p>
    <p>Vous avez demandé à réinitialiser votre mot de passe. Pour cela, veuillez cliquer sur le lien ci-dessous :</p>
    <a href=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_reset_password", ["token" => twig_get_attribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 10, $this->source); })()), "token", [], "any", false, false, false, 10)]), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_reset_password", ["token" => twig_get_attribute($this->env, $this->source, (isset($context["resetToken"]) || array_key_exists("resetToken", $context) ? $context["resetToken"] : (function () { throw new RuntimeError('Variable "resetToken" does not exist.', 10, $this->source); })()), "token", [], "any", false, false, false, 10)]), "html", null, true);
        echo "</a>
...
";
    ...
    {
        return array (  103 => 11,  97 => 10,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Mot de passe perdu - {{ parent() }}{% endblock %}
...
{% block body %}
    ...
    <p>Bonne journée!</p>
{% endblock %}", "reset_password/email.html.twig", "/Users/wowlfyy/wildcodeschool/checkpoint4/templates/reset_password/email.html.twig");
    }
}
